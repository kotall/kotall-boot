...
insert INTO `sys_org`(`parent_id`,`code`,`name`,`order_num`,`status`,`create_time`,`update_time`) values (0,'BMS','综合业务运营平台',0,1,NOW(),NOW());

insert  into `sys_user`(`user_id`,`org_id`,`username`,`password`,`email`,`mobile`,`status`,`remark`,`user_id_create`,`create_time`,`update_time`)
values (1,(select o.org_id from sys_org o where o.code='BMS'),'admin','33808479d49ca8a3cdc93d4f976d1e3d','admin@kotall.com','15001906953',1,NULL,1,NOW(),NOW());


INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (1514558, 0, '/sys', '系统管理', NULL, '', 0, 'fa fa-coffee', 0, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1433386864 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/menu', '系统菜单', 'base/menu/list.html', NULL, 1, 'fa fa-th-list', 1, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1642423619 , (select m.menu_id from sys_menu m where m.code='/sys/menu'), '/sys/menu/list', '刷新', NULL, 'sys:menu:list', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1642222692 , (select m.menu_id from sys_menu m where m.code='/sys/menu'), '/sys/menu/save', '新增', NULL, 'sys:menu:save', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1642637271 , (select m.menu_id from sys_menu m where m.code='/sys/menu'), '/sys/menu/edit', '编辑', NULL, 'sys:menu:edit', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1948199197 , (select m.menu_id from sys_menu m where m.code='/sys/menu'), '/sys/menu/remove', '删除', NULL, 'sys:menu:remove', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431709293  , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/org', '机构管理', 'base/org/list.html', NULL, 1, 'fa fa-sitemap', 2, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-533255270 , (select m.menu_id from sys_menu m where m.code='/sys/org'), '/sys/org/list', '刷新', NULL, 'sys:org:list', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-533054343 , (select m.menu_id from sys_menu m where m.code='/sys/org'), '/sys/org/save', '新增', NULL, 'sys:org:save', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-533468922 , (select m.menu_id from sys_menu m where m.code='/sys/org'), '/sys/org/edit', '编辑', NULL, 'sys:org:edit', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1189305216  , (select m.menu_id from sys_menu m where m.code='/sys/org'), '/sys/org/remove', '删除', NULL, 'sys:org:remove', 2, NULL, 0, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1433135364   , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/user', '用户管理', 'base/user/list.html', NULL, 1, 'fa fa-user', 3, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (223864785   , (select m.menu_id from sys_menu m where m.code='/sys/user'), '/sys/user/list', '刷新', NULL, 'sys:user:list', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (224065712   , (select m.menu_id from sys_menu m where m.code='/sys/user'), '/sys/user/save', '新增', NULL, 'sys:user:save', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (223651133   , (select m.menu_id from sys_menu m where m.code='/sys/user'), '/sys/user/edit', '编辑', NULL, 'sys:user:edit', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (553594615 , (select m.menu_id from sys_menu m where m.code='/sys/user'), '/sys/user/remove', '删除', NULL, 'sys:user:remove', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (189357046  , (select m.menu_id from sys_menu m where m.code='/sys/user'), '/sys/user/enable', '启用', NULL, 'sys:user:enable', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (561035989 , (select m.menu_id from sys_menu m where m.code='/sys/user'), '/sys/user/disable', '停用', NULL, 'sys:user:disable', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1249880414 , (select m.menu_id from sys_menu m where m.code='/sys/user'), '/sys/user/restpassword', '重置密码', NULL, 'sys:user:resetPassword', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1433228377   , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/role', '角色管理', 'base/role/list.html', NULL, 1, 'fa fa-paw', 4, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (220366342   , (select m.menu_id from sys_menu m where m.code='/sys/role'), '/sys/role/list', '刷新', NULL, 'sys:role:list', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (220567269   , (select m.menu_id from sys_menu m where m.code='/sys/role'), '/sys/role/save', '新增', NULL, 'sys:role:save', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (220152690   , (select m.menu_id from sys_menu m where m.code='/sys/role'), '/sys/role/edit', '编辑', NULL, 'sys:role:edit', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (1486558188 , (select m.menu_id from sys_menu m where m.code='/sys/role'), '/sys/role/remove', '删除', NULL, 'sys:role:remove', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (289253234     , (select m.menu_id from sys_menu m where m.code='/sys/role'), '/sys/role/authorizeOpt', '操作权限', NULL, 'sys:role:authorizeOpt', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (376573643   , (select m.menu_id from sys_menu m where m.code='/sys/role'), '/sys/role/authorizeData', '数据权限', NULL, 'sys:role:authorizeData', 2, NULL, 0, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1433651481 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/dict', '通用字典', 'base/dict/list.html', NULL, 1, 'fa fa-book', 5, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1080163642 , (select m.menu_id from sys_menu m where m.code='/sys/dict'), '/sys/dict/list', '刷新', NULL, 'sys:dict:list', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1079962715 , (select m.menu_id from sys_menu m where m.code='/sys/dict'), '/sys/dict/save', '新增', NULL, 'sys:dict:save', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1080377294 , (select m.menu_id from sys_menu m where m.code='/sys/dict'), '/sys/dict/edit', '编辑', NULL, 'sys:dict:edit', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (1512726700  , (select m.menu_id from sys_menu m where m.code='/sys/dict'), '/sys/dict/remove', '删除', NULL, 'sys:dict:remove', 2, NULL, 0, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1433732162 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/area', '行政区域', 'base/area/list.html', NULL, 1, 'fa fa-leaf', 6, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-216290225  , (select m.menu_id from sys_menu m where m.code='/sys/area'), '/sys/area/list', '刷新', NULL, 'sys:area:list', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-216089298  , (select m.menu_id from sys_menu m where m.code='/sys/area'), '/sys/area/save', '新增', NULL, 'sys:area:save', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-216503877  , (select m.menu_id from sys_menu m where m.code='/sys/area'), '/sys/area/edit', '编辑', NULL, 'sys:area:edit', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1528574987 , (select m.menu_id from sys_menu m where m.code='/sys/area'), '/sys/area/remove', '删除', NULL, 'sys:area:remove', 2, NULL, 0, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (922658355 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/config', '系统配置', 'base/config/list.html', '', 1, NULL, 7, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (369705722 , (select m.menu_id from sys_menu m where m.code='/sys/config'), '/sys/config/list', '刷新', NULL, 'sys:config:list', 2, 'fa fa-file-code-o', 1, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (369906649 , (select m.menu_id from sys_menu m where m.code='/sys/config'), '/sys/config/save', '新增', NULL, 'sys:config:save', 2, 'fa fa-file-code-o', 2, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (369492070 , (select m.menu_id from sys_menu m where m.code='/sys/config'), '/sys/config/edit', '编辑', NULL, 'sys:config:edit', 2, 'fa fa-file-code-o', 3, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1027185696 , (select m.menu_id from sys_menu m where m.code='/sys/config'), '/sys/config/remove', '删除', NULL, 'sys:config:remove', 2, 'fa fa-file-code-o', 4, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431712269 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/log', '系统日志', 'base/log/list.html', NULL, 1, 'fa fa-warning', 8, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (165737274   , (select m.menu_id from sys_menu m where m.code='/sys/log'), '/sys/log/list', '刷新', NULL, 'sys:log:list', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (527631392   , (select m.menu_id from sys_menu m where m.code='/sys/log'), '/sys/log/remove', '删除', NULL, 'sys:log:remove', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (834651953   , (select m.menu_id from sys_menu m where m.code='/sys/log'), '/sys/log/clear', '清空', NULL, 'sys:log:clear', 2, NULL, 0, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1493237775 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/druid', '系统监控', 'druid/index.html', '', 1, 'fa fa-bug', 9, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431714196 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/job', '定时任务', 'base/job/list.html', NULL, 1, 'fa fa-bell', 10, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (831938145   , (select m.menu_id from sys_menu m where m.code='/sys/job'), '/sys/job/list', '刷新', NULL, 'quartz:job:list', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (832139072   , (select m.menu_id from sys_menu m where m.code='/sys/job'), '/sys/job/save', '新增', NULL, 'quartz:job:save', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (831724493   , (select m.menu_id from sys_menu m where m.code='/sys/job'), '/sys/job/edit', '编辑', NULL, 'quartz:job:edit', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (796541319   , (select m.menu_id from sys_menu m where m.code='/sys/job'), '/sys/job/remove', '删除', NULL, 'quartz:job:remove', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (831973656   , (select m.menu_id from sys_menu m where m.code='/sys/job'), '/sys/job/more', '更多', NULL, 'quartz:job:more', 1, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (293024346   , (select m.menu_id from sys_menu m where m.code='/sys/job/more'), '/sys/job/more/enable', '启用', NULL, 'quartz:job:enable', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-520245007  , (select m.menu_id from sys_menu m where m.code='/sys/job/more'), '/sys/job/more/disable', '停用', NULL, 'quartz:job:disable', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (1264825620  , (select m.menu_id from sys_menu m where m.code='/sys/job/more'), '/sys/job/more/run', '立即执行', NULL, 'quartz:job:run', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (442478881   , (select m.menu_id from sys_menu m where m.code='/sys/job'), '/sys/job/log', '日志列表', NULL, 'quartz:job:log', 1, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-840966964  , (select m.menu_id from sys_menu m where m.code='/sys/job/log'), '/sys/job/log/list', '刷新', NULL, 'quartz:log:list', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-547499726  , (select m.menu_id from sys_menu m where m.code='/sys/job/log'), '/sys/job/log/remove', '删除', NULL, 'quartz:log:remove', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-308408353  , (select m.menu_id from sys_menu m where m.code='/sys/job/log'), '/sys/job/log/clear', '清空', NULL, 'quartz:log:clear', 2, NULL, 0, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431717377 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/gen', '敏捷开发', 'base/gen/list.html', NULL, 1, 'fa fa-archive', 11, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-43077970   , (select m.menu_id from sys_menu m where m.code='/sys/gen'), '/sys/gen/list', '刷新', NULL, 'sys:gen:list', 2, NULL, 0, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-43340803   , (select m.menu_id from sys_menu m where m.code='/sys/gen'), '/sys/gen/code', '生成代码', NULL, 'sys:gen:code', 2, NULL, 0, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431709250 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/oss', '存储管理', 'base/oss/list.html', '', 1, NULL, 12, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (697798223 , (select m.menu_id from sys_menu m where m.code='/sys/oss'), '/sys/oss/list', '刷新', NULL, 'sys:oss:list', 2, 'fa fa-file-code-o', 1, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (697999150 , (select m.menu_id from sys_menu m where m.code='/sys/oss'), '/sys/oss/save', '新增', NULL, 'sys:oss:save', 2, 'fa fa-file-code-o', 2, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (697584571 , (select m.menu_id from sys_menu m where m.code='/sys/oss'), '/sys/oss/edit', '编辑', NULL, 'sys:oss:edit', 2, 'fa fa-file-code-o', 3, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (737095157 , (select m.menu_id from sys_menu m where m.code='/sys/oss'), '/sys/oss/remove', '删除', NULL, 'sys:oss:remove', 2, 'fa fa-file-code-o', 4, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (833110898 , (select m.menu_id from sys_menu m where m.code='/sys/oss'), '/sys/oss/upload', '上传', NULL, 'sys:oss:upload', 2, 'fa fa-file-code-o', 4, NOW(), NOW());

INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `name`, `code`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431722807 , (select m.menu_id from sys_menu m where m.code='/sys'), 'API管理', '/sys/api', 'apidoc/index.html', '', 1, 'fa fa-book', 13, NOW(), NOW());
