...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1433135364   , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/user', '用户管理', 'base/user/list.html', NULL, 1, 'fa fa-user', 2, NOW(), NOW());
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1433228377   , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/role', '角色管理', 'base/role/list.html', NULL, 1, 'fa fa-paw', 1, NOW(), NOW());
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431709293  , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/org', '机构管理', 'base/org/list.html', NULL, 1, 'fa fa-sitemap', 0, NOW(), NOW());
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1433651481 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/dict', '通用字典', 'base/dict/list.html', NULL, 1, 'fa fa-book', 2, NOW(), NOW());
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431712269 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/log', '系统日志', 'base/log/list.html', NULL, 1, 'fa fa-warning', 3, NOW(), NOW());
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1433732162 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/area', '行政区域', 'base/area/list.html', NULL, 1, 'fa fa-leaf', 0, NOW(), NOW());
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431714196 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/job', '定时任务', 'base/job/list.html', NULL, 1, 'fa fa-bell', 4, NOW(), NOW());
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431717377 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/gen', '敏捷开发', 'base/gen/list.html', NULL, 1, 'fa fa-archive', 5, NOW(), NOW());
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1493237775 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/druid', '系统监控', 'druid/index.html', '', 1, 'fa fa-bug', 6, NOW(), NOW());
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `name`, `code`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431722807 , (select m.menu_id from sys_menu m where m.code='/sys'), 'API', '/sys/api', 'apidoc/index.html', '', 1, 'fa fa-book', 7, NOW(), NOW());


INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (922658355 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/config', '系统配置', 'base/config/list.html', '', 1, NULL, 8, NOW(), NOW());
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `code`, `name`, `url`, `perms`, `type`, `icon`, `order_num`, `create_time`, `update_time`) VALUES (-1431709250 , (select m.menu_id from sys_menu m where m.code='/sys'), '/sys/oss', 'OSS配置', 'base/oss/list.html', '', 1, NULL, 9, NOW(), NOW());
