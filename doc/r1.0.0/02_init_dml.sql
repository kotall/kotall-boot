...
-- 菜单SQL
INSERT INTO `sys_menu` (`parent_id`, `name`, `code`,`url`, `perms`, `type`, `icon`, `order_num`) VALUES ((select m.menu_id from sys_menu m where m.code='LITE_MALL_UC_USER'), '用户管理', 'LITE_MALL_USER_','mall/user/list.html', NULL, '1', 'fa fa-th-list', 1);
-- 菜单对应按钮SQL
