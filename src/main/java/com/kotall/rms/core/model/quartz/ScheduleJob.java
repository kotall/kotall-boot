...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        String jobStr = context.getMergedJobDataMap().getString(SysJobEntity.JOB_PARAM_KEY);
    	SysJobEntity scheduleJob = JSONUtils.jsonToBean(jobStr, SysJobEntity.class);
        
        //获取spring bean
        SysJobLogManager sysJobLogManager = (SysJobLogManager) SpringContextUtils.getBean("sysJobLogManager");
        ...
        try {
			...
			sysJobLogManager.saveQuartzJobLog(log);
		}
    }
}
