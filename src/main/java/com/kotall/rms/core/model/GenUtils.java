package com.kotall.rms.core.model;
...
public class GenUtils {
	 ...
	 * 生成代码
	 */
	public static void generatorCode(SysGenTableEntity table, List<SysGenColumnEntity> columns, SysGenParamEntity params,
									 ZipOutputStream zip) {
		// 配置信息
		...
		// 列信息
		for (SysGenColumnEntity column : columns) {
			// 列名转换，java属性名及对应方法名
		...
		for (String template : templates) {
			...
			try {
				...
				throw new RmsException("渲染模板失败，表名：" + table.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig() {
		try {
			...
			throw new RmsException("获取配置文件失败，", e);
		}
	}
	...
	public static String getFileName(String template, String className, String module, String functionCode,
		...
		if (template.contains("Entity.java.vm")) {
			return packagePath + "common"+ File.separator +"entity" + File.separator + module + File.separator + className + "Entity.java";
		}

		if (template.contains("Mapper.java.vm")) {
			return packagePath + "common"+ File.separator + "dao" + File.separator + module + File.separator + className + "Mapper.java";
		}

		if (template.contains("Mapper.xml.vm")) {
			return packagePath + "common"+ File.separator + "dao" + File.separator + module + File.separator + className + "Mapper.xml";
		}

		if (template.contains("Manager.java.vm")) {
			return packagePath + "common"+ File.separator + "manager" + File.separator + module + File.separator + className + "Manager.java";
		}

		if (template.contains("ManagerImpl.java.vm")) {
			return packagePath + "common"+ File.separator + "manager" + File.separator + module + File.separator + "impl" + File.separator + className + "ManagerImpl.java";
		}

		if (template.contains("Service.java.vm")) {
			return packagePath + "core"+ File.separator + "service" + File.separator + module + File.separator + className + "Service.java";
		}

		if (template.contains("ServiceImpl.java.vm")) {
			return packagePath + "core"+ File.separator + "service" + File.separator + module + File.separator  + "impl" + File.separator + className + "ServiceImpl.java";
		}

		if (template.contains("Controller.java.vm")) {
			return packagePath + "web"+ File.separator + "controller" + File.separator + module + File.separator + className + "Controller.java";
		}
